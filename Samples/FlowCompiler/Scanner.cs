	...
	Token NextToken() {
		...
		switch (state) {
			...
			case 4:
				...
				if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'F' || ch >= 'a' && ch <= 'f') {AddCh(); goto case 4;}
				else if (ch == 'U') {AddCh(); goto case 59;}
				else if (ch == 'u') {AddCh(); goto case 60;}
			...
			case 35:
				...
				else if (ch == 92) {AddCh(); goto case 66;}
				else {goto case 0;}
			case 36:
			...
			case 37:
				...
				else if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'F' || ch >= 'a' && ch <= 'f') {AddCh(); goto case 67;}
				else if (ch == '"') {AddCh(); goto case 52;}
				else if (ch == 92) {AddCh(); goto case 66;}
				else {goto case 0;}
			case 38:
			...
			case 53:
				...
				else if (ch == 'U') {AddCh(); goto case 55;}
				else if (ch == 'u') {AddCh(); goto case 56;}
				else if (ch == 'L') {AddCh(); goto case 57;}
				else if (ch == 'l') {AddCh(); goto case 58;}
				else if (ch == '.') {apx++; AddCh(); goto case 70;}
