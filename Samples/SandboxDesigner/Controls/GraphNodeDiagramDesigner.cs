...
namespace Aurora.SandboxDesigner.Controls
{
    ...
    public class GraphNodeDiagramDesigner : DesignerCanvas
    {
        public static readonly DependencyProperty NamespaceProperty =
            DependencyProperty.Register("Namespace", typeof(object), typeof(GraphNodeDiagramDesigner),
                    new FrameworkPropertyMetadata(null, FrameworkPropertyMetadataOptions.None));

        public object Namespace
        {
            get { return GetValue(GraphNodeDiagramDesigner.NamespaceProperty); }
            set { SetValue(GraphNodeDiagramDesigner.NamespaceProperty, value); }
        }
        ...
        void b_Executed(object sender, ExecutedRoutedEventArgs e)
        {
            ...
            if ( menu != null )
            {
                if ((e.OriginalSource as TreeViewItem) != null && (e.OriginalSource as TreeViewItem).DataContext == e.Parameter)
                {
                    ...
                    else if (header == "Comment2")
                    {
                        DesignerStatement comment = new DesignerStatement();
                        //ConnectionLayer.Children.Add(comment);
                    ...
                    else if (header == "Comment3")
                    {
                        DesignerRoutine comment = new DesignerRoutine();
                        //ConnectionLayer.Children.Add(comment);
        ...
        public void Save(System.IO.Stream stream)
        {
            ...
            using (System.Xml.XmlWriter writer = System.Xml.XmlTextWriter.Create(stream, settings))
            {
                ...
                writer.WriteAttributeString("Namespace", Namespace.ToString());
    ...
    public class DesignerStatement : DesignerComment
    {

    }

    public class DesignerRoutine : DesignerComment
    {
